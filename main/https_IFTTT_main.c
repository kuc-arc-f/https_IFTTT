...
#define WEB_PORT "443"
#define WEB_URL "https://maker.ifttt.com"
	
#define mAPI_KEY "your-KEY"
#define mTrigger "test"
...
/* Root cert for , taken from server_root_cert.pem
    ...
    */
    ...
    while(1) {
        ...
        */
		...
		printf("sBuff=%s\n", sBuff);
        while((ret = mbedtls_ssl_write(&ssl, (const unsigned char *)sBuff, strlen(sBuff ))) <= 0)
        {
            if(ret != MBEDTLS_ERR_SSL_WANT_READ && ret != MBEDTLS_ERR_SSL_WANT_WRITE)
            {
